...
public class QMenuImage extends EntityPathBase<MenuImage> {
    ...
    public final com.example.shortapitest.eLearningApi.entity.eLearning.QELearningMenu eLearningMenu;
    ...
    public QMenuImage(Class<? extends MenuImage> type, PathMetadata metadata, PathInits inits) {
        ...
        this.eLearningMenu = inits.isInitialized("eLearningMenu") ? new com.example.shortapitest.eLearningApi.entity.eLearning.QELearningMenu(forProperty("eLearningMenu"), inits.get("eLearningMenu")) : null;
    }
